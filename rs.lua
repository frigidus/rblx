--[[
    ...
    Credits:
        ...
        Frosty - GUI to Lua
        NoobSploit - Fixed Vector3 and CFrame values returning nil
]]
...
function u2s(u)
    ...
    elseif typeof(u) == "Vector2" then
    	return string.format("Vector2.new(%s, %s)", v2s(u.X), v2s(u.Y))
    ...
    elseif typeof(u) == "Rect" then
        ...
        return string.format("%s(nil)", typeof(u))
    end
end
...
if not _G.SimpleSpyExecuted then
    local succeeded, err = pcall(function()
        ...
        syn.protect_gui(gui)
        SimpleSpy2.Parent = gui --Parents ui to Infinite Yield
